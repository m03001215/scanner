...
from btcpred import backtest, calibration, calibration_report, data, early10, early30, features, gate, htf, intra, intra10, llm, model, predictor, rl, ta
...
def cmd_train_v7(args):
    """v7: v1's features plus closed 1h/4h context; paired walk-forward against v1."""
    htf.train(args.days)
    print(f"saved to {htf.v7_dir()}")
...
def main():
    ...
    s = add("train-v7", "v7: v1 + higher-timeframe (1h/4h) features (15m)"); s.add_argument("--days", type=int, default=1095)
    ...
    {"fetch": cmd_fetch, "train": cmd_train, "backtest-ta": cmd_backtest_ta, "backtest": cmd_backtest,
     "backtest-llm": cmd_backtest_llm, "train-rl": cmd_train_rl, "calibrate": cmd_calibrate, "train-intra": cmd_train_intra, "train-intra10": cmd_train_intra10, "train-v4": cmd_train_v4, "train-v5": cmd_train_v5, "train-v6": cmd_train_v6, "train-v7": cmd_train_v7, "predict": cmd_predict}[args.cmd](args)
